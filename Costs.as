...
namespace CTFCosts
{
	...
	s32 buildershop_wood, quarters_wood, knightshop_wood, archershop_wood,
		...
		quarry_stone, quarry_gold, ballista_gold, quarry_count;
...
void InitCosts()
{
	...
	//VehicleShop.as
	CTFCosts::catapult =                    ReadCost(cfg, costs, "cost_catapult"                   , 80);
	CTFCosts::ballista =                    ReadCost(cfg, costs, "cost_ballista"                   , 200);
	CTFCosts::ballista_ammo =               ReadCost(cfg, costs, "cost_ballista_ammo"              , 50);
